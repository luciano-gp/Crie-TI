...
let sql = [
    ...
    `CREATE TABLE "produto" (
        ...
        `INSERT INTO produto (nome,valor) VALUES('Pelota Quadrada',69.56) RETURNING id;`,
        `INSERT INTO produto (nome,valor) VALUES('Pelota Redonda',10.56) RETURNING id;`
];
