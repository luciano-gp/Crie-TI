...
public class JogoVelha {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            mostra(velha);
        } while ((verifica(velha) == 666) && (cont != 9));

        switch (verifica(velha)) {
            case 0 -> Mensagem.aviso("Vencedor - jogador 1");
            case -1 -> Mensagem.aviso("Vencedor - jogador 2");
            default -> Mensagem.aviso("Empate");
        }
